...
def process(dataset, pushd):
    ...
    os.system(
        ' onepanel jobs create "python /onepanel/code/nodered/model.py ' + dataset + ' /onepanel/input && pip install onepanel==2.13.2b0 && cd /onepanel/cnn && onepanel datasets init -n ' + pushd + '  && onepanel push -y" --machine-type gpu-8-52-1v100 --environment jupyter-py3-tensorflow1.11.0 --storage default-storage-10 ')
